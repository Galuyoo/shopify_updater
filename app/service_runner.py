    ...
    while True:
        ...
        for store_key in stores:
            ...
            try:
                ...
                # ✅ With the updated run_update() I gave you:
                # - build_map=True  => full build + return early (manual mode)
                # - missing map     => auto-create starter map safely (service mode)
                ...
                lines.append(
                    f"{store_key}: updated={summary['updated']} dry={summary['dry']} "
                    f"errors={summary['errors']} translated={summary['translated']} "
                    f"elapsed={summary['elapsed_secs']}s"
                )
